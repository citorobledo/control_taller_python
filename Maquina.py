...
class Maquina:
    ...
    def ponerOperativa(self):
        self.registrarReparacion()
        self.registroDeReparacines[-1] += "la maquina estuvo fuera de servicio: " \
                                          + str(self.tiempoFueraDeServicio()) + " dias"
        self.operativa = True

    def registrarReparacion(self):
